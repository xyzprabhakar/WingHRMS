...
$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        $('#btnsave').bind("click", function () {
            ...
            var ddlcomp = company_id;
            var ddlemp = login_emp_id;
...
function BindRequestDetail(companyId) {
    //// debugger;;
            ...
            $("#tblreimbrequestapproval").DataTable({
                ...
                "columnDefs":
                    [
                        ...
                        //    targets: [2],
                        //    render: function (data, type, row) {
                        //        return data == '1' ? 'Temporary' : data == '2' ? 'Probation' : data == '3' ? 'Confirmed' : data == '4' ? 'Contract' : data == '10' ? 'Notice' : data == '100' ? 'Terminate' : data=='99'?'FNF':''
                        //    }
                        //},
                        {
                            targets: [3],
