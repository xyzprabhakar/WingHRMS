    ...
    setTimeout(function () {
        ...
        $("#SameAsPermanentAddress").change(function () {
            ...
            if (this.checked) {
                ...
                if ($("#permanent_state").val() != 'Select State' && $("#permanent_state").val() != undefined && $("#permanent_state").val() != null) {
                ...
                if (($("#permanent_city").val() != "Select City" && $("#permanent_city").val() != 0) || $("#permanent_city").val() != null) {
        ...
        $("#chkSameAsPermanentAddressEmer").change(function () {
            if (this.checked) {
                ...
                var permanent_state = 0;
                if ($("#permanent_state").val() != 'Select State' && $("#permanent_state").val() != null && $("#permanent_state").val() != undefined) {
                    permanent_state = $("#permanent_state").val();
                }
                else {
                    alert('Please Select Permanent State....');
                ...
                var permanent_city = 0;
                if ($("#permanent_city").val() != 'Select City' && $("#permanent_city").val() != null && $("#permanent_city").val() != undefined) {
                    permanent_city = $("#permanent_city").val();
                }
                else {
                    alert('Please Select Permanent City....');
        ...
        $("#chkSameAsCorrespondingAddressEmer").change(function () {
            if (this.checked) {
                ...
                if ($("#corresponding_state").val() != 'Select State' || $("#corresponding_state").val() != null || $("#corresponding_state").val() != undefined) {
                    corresponding_state = $("#corresponding_state").val();
                }
                else {
                    alert('Please Select Corresponding State....');
                    $("#corresponding_state").focus();
                    $('#loader').hide();
                    return;
                }
                ...
                if ($("#corresponding_city").val() != 'Select City' || $("#corresponding_city").val() != null || $("#corresponding_city").val() != undefined) {
                    corresponding_city = $("#corresponding_city").val();
                }
                else {
                    alert('Please Select Corresponding City....');
                    $("#corresponding_city").focus();
                    $('#loader').hide();
                    return;
                }
    ...
    if (employee_id > 0) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (res != null) {
                    $("#pan_card_name").val(res.pan_card_name);
                    $("#pan_card_number").val(res.pan_card_number);
                    $("#hdnpan_card_image").val(res.pan_card_image);
                    $("#aadha_card_name").val(res.aadha_card_name);
                    $("#aadha_card_number").val(res.aadha_card_number);
                    $("#hdnaadha_card_image").val(res.aadha_card_image);
