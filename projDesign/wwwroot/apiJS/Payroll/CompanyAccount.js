...
$('#btnreset').bind('click', function () {
    window.location.href = '/Payroll/CompanyAccount';
...
function GetEditData(id) {
    ...
    $("#hdnid").val(id);
    var apiurl = localstorage.getItem("ApiUrl") + "apiPayroll/Get_companyacc/" + id;
    $.ajax({
        type: "GET",
        url: apiurl,
        data: {},
        ...
        success: function (res) {
            ...
            $('#companyaccno').val(data.cmpny_acct_no);
...
$("#btnupdate").bind("click", function () {
    ...
    var companyacc = $('#companyaccno').val();
    ...
    if (companyacc == '' || companyacc == '0') {
        errormsg = errormsg + 'Please enter Company Account no. !! <br />';
        iserror = true;
    }
    ...
    var myData = {
        ...
        'bank_name': bank,
        'branch_id': branch,
        'cmpny_acct_no': companyacc,
        'opn_date': openingdate,
        'created_by': login_emp_id,
        'modified_by': login_emp_id,
    };
    var apiurl = localStorage.getItem("ApiUrl") + 'apiPayroll/Update_CompanyaccMaster';
...
$('#btnsave').bind("click", function () {
    ...
    var apiurl = localStorage.getItem("ApiUrl") + 'apiPayroll/Save_CompanyAccount';
    var Obj = JSON.stringify(myData);
    var headerss = {};
    headerss["Authorization"] = 'Bearer ' + localStorage.getItem('Token');
    headerss["salt"] = $("#hdnsalt").val();
...
function GetData() {
    // debugger;
    var apiurl = localStorage.getItem("ApiUrl") + 'apiPayroll/Get_companyacc/0'; //change link here
        ...
        success: function (res) {
            ...
            $("#companyacct").DataTable({
                ...
                "columns": [
                    ...
                    { "data": "cmpny_acct_no", "name": "cmpny_acct_no", "autoWidth": true },
