...
namespace projDayStatus
{
    ...
    public class LeaveCredit
    {
        ...
        public string LeaveCredit_AllInstance()
        {
                ...
                if (ObjResult.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    for (int Index = 0; Index < InstanceList.Count; Index++)
                    {
                        try
                        {
                            ...
                            //if (!(InstanceList[Index].organisation == "localhost"))
                            {
                                continue;
                            }
                            ...
                            if (ObjToken.tokken != "")
                            {
                                ...
                                if (ObjGuid.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    var request1 = new RestRequest("/Attendance/EmployeeLeaveCreditAndDebit", Method.GET);
        ...
        public string LeaveCredit_AllInstance(List<clsInsatnce> InstanceList)
        {
            Api_log log = new Api_log();
            try
            {
