...
namespace projDayStatus
{
    ...
    public class LWP
    {
                        ...
                        try
                        {
                            ...
                            if (ObjToken.tokken != "")
                            {
                                ...
                                if (ObjGuid.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    var request1 = new RestRequest("/apiPayroll/LWPEntry_Schedular", Method.GET);
        ...
        public string LWPEntry(List<clsInsatnce> InstanceList)
        {
            Api_log log = new Api_log();
            try
            {
