...
namespace projDayStatus
{
    public class AttendanceNotification
    {
        ...
        public string WeeklyAttendanceNotification()
        {
                        ...
                        try
                        {
                            ...
                            if (ObjToken.tokken != "")
                            {
                                ...
                                if (ObjGuid.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    var request1 = new RestRequest("/apiMasters/WeeklyAttendanceNotification", Method.GET);
                                    ...
                                    log.api_type = "Weekly Attendance Notification";
        ...
        public string WeeklyAttendanceNotification(List<clsInsatnce> InstanceList)
        {
            Api_log log = new Api_log();
            try
            {
        ...
        public string LastDayAbsentNotification()
        {
            Api_log log = new Api_log();
            try
            {
                        ...
                        try
                        {
                            ...
                            if (ObjToken.tokken != "")
                            {
                                ...
                                if (ObjGuid.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    RestClient client1 = new RestClient(ObjToken.ApibaseUrl);
                                    client1.AddDefaultHeader("authorization", "Bearer " + ObjToken.tokken);
                                    var request1 = new RestRequest("/apiMasters/LastDayAbsentNotification", Method.GET);
                                    request1.AddHeader("cache-control", "no-cache");
                                    request1.AddParameter("salt", guid_, ParameterType.HttpHeader);
                                    ...
                                    log.api_type = "Last Day Absent Notification";
                                    log.entrydate = DateTime.Now;
                                    log.instance_id = InstanceList[Index].instance_id;
                                    log.response = ObjResult_.Content == "" ? ObjResult_.StatusDescription : ObjResult_.Content;
        ...
        public string LastDayAbsentNotification(List<clsInsatnce> InstanceList)
        {
            Api_log log = new Api_log();
            try
            {
