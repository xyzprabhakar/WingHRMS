   ...
   public class ShiftNotification
    {
        ...
        public string ShiftAssignmentNotification()
        {
                        ...
                        try
                        {
                            ...
                            if (ObjToken.tokken != "")
                            {
                                ...
                                if (ObjGuid.StatusCode == System.Net.HttpStatusCode.OK)
                                {
                                    ...
                                    var request1 = new RestRequest("/apiShift/Shift_Change_Notification", Method.POST);
                                    ...
                                    log.api_type = "Shift Change Notification";
        ...
        public string ShiftAssignmentNotification(List<clsInsatnce> InstanceList)
        {
            Api_log log = new Api_log();
            try
            {
