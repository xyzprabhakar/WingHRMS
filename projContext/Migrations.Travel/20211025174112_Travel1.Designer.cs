...
namespace projContext.Migrations.Travel
{
    ...
    [Migration("20211025174112_Travel1")]
    partial class Travel1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projContext.DB.CRM.Travel.tblFlightSearchResponse_Caching", b =>
                {
                    ...
                    b.HasIndex("CachingId");

                    b.ToTable("tblFlightSearchResponse_Caching");
                });
            ...
            modelBuilder.Entity("projContext.DB.CRM.Travel.tblFlightFareDetail_Caching", b =>
                {
                    b.HasOne("projContext.DB.CRM.Travel.tblFlightFare_Caching", "tblFlightFare_Caching")
                        .WithMany()
            ...
            modelBuilder.Entity("projContext.DB.CRM.Travel.tblFlightSearchResponse_Caching", b =>
                {
                    b.HasOne("projContext.DB.CRM.Travel.tblFlightSearchRequest_Caching", "tblFlightSearchRequest_Caching")
                        .WithMany("tblFlightSearchResponse_Caching")
                        .HasForeignKey("CachingId");
                });

            modelBuilder.Entity("projContext.DB.CRM.Travel.tblFlightSearchResponses_Caching", b =>
                {
                    b.HasOne("projContext.DB.CRM.Travel.tblFlightSearchResponse_Caching", "tblFlightSearchResponse_Caching")
