...
namespace projContext.Migrations
{
    ...
    [Migration("20210131071258_weekoffEffectiveFrom1")]
    partial class weekoffEffectiveFrom1
    {
            ...
            modelBuilder.Entity("projContext.DB.tbl_app_setting", b =>
                {
                    ...
                    b.Property<string>("AppSettingKeyDisplay");
            ...
            modelBuilder.Entity("projContext.DB.tbl_fnf_attendance_dtl", b =>
                {
                    ...
                    b.Property<double>("actual_paid_days");
                    ...
                    b.Property<double>("paid_days");

                    b.Property<double>("total_days");
