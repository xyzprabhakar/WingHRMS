        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    calling_function_name = table.Column<string>(nullable: true),
                    function_category = table.Column<int>(nullable: false),
                    computation_order = table.Column<int>(nullable: false),
                    created_by = table.Column<int>(nullable: false),
                    created_dt = table.Column<DateTime>(nullable: false),
                    modified_by = table.Column<int>(nullable: false),
                    modified_dt = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_function_master", x => x.function_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    key_id = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    key_name = table.Column<string>(maxLength: 50, nullable: true),
                    display_name = table.Column<string>(maxLength: 50, nullable: true),
                    description = table.Column<string>(maxLength: 200, nullable: true),
                    type = table.Column<int>(nullable: false),
                    calling_function_name = table.Column<string>(maxLength: 50, nullable: true),
                    computation_order = table.Column<int>(nullable: false),
                    defaultvalue = table.Column<string>(nullable: true),
                    data_type = table.Column<string>(nullable: true),
                    forumal_name = table.Column<string>(maxLength: 50, nullable: true),
                    created_by = table.Column<int>(nullable: false),
                    created_dt = table.Column<DateTime>(nullable: false),
                    modified_by = table.Column<int>(nullable: false),
                    modified_dt = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_key_master", x => x.key_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    modified_by = table.Column<int>(nullable: false),
                    modified_date = table.Column<DateTime>(nullable: false),
                    urll = table.Column<string>(maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bank_acc = table.Column<string>(nullable: true),
                    ifsc_code = table.Column<string>(nullable: true),
                    bank_id = table.Column<int>(nullable: false),
                    uan = table.Column<string>(nullable: true),
                    esic = table.Column<string>(nullable: true),
                    pf_applicable = table.Column<int>(nullable: false),
                    pf_number = table.Column<string>(nullable: true),
                    pf_group = table.Column<int>(nullable: false),
                    pf_ceilling = table.Column<double>(nullable: false),
                    is_deleted = table.Column<byte>(nullable: false),
                    created_by = table.Column<int>(nullable: false),
                    created_date = table.Column<DateTime>(nullable: false),
                    last_modified_by = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_emp_personal_sec_tbl_bank_master_bank_id",
                        column: x => x.bank_id,
            ...
            migrationBuilder.CreateTable(
                name: "tbl_key_forumala",
                columns: table => new
                {
                    sno = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    for_formula_id = table.Column<int>(nullable: true),
                    used_key_id = table.Column<int>(nullable: true),
                    used_function_id = table.Column<int>(nullable: true),
                    static_value = table.Column<string>(nullable: true),
                    static_value_type = table.Column<string>(nullable: true),
                    calculation_order = table.Column<int>(nullable: false),
                    created_by = table.Column<int>(nullable: false),
                    created_dt = table.Column<DateTime>(nullable: false),
                    modified_by = table.Column<int>(nullable: false),
                    modified_dt = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_key_forumala", x => x.sno);
                    table.ForeignKey(
                        name: "FK_tbl_key_forumala_tbl_key_master_for_formula_id",
                        column: x => x.for_formula_id,
                        principalTable: "tbl_key_master",
                        principalColumn: "key_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_key_forumala_tbl_function_master_used_function_id",
                        column: x => x.used_function_id,
                        principalTable: "tbl_function_master",
                        principalColumn: "function_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_key_forumala_tbl_key_master_used_key_id",
                        column: x => x.used_key_id,
                        principalTable: "tbl_key_master",
                        principalColumn: "key_id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                name: "tbl_create_batch",
                columns: table => new
                {
                    batch_id = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    batch_name = table.Column<string>(maxLength: 100, nullable: true),
                    company_id = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_create_batch", x => x.batch_id);
                    table.ForeignKey(
                        name: "FK_tbl_create_batch_tbl_component_master_company_id",
                        column: x => x.company_id,
                        principalTable: "tbl_component_master",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_create_batch_tbl_department_master_dept_id",
                        column: x => x.dept_id,
            ...
            migrationBuilder.CreateTable(
                name: "tbl_salary_group_key_used",
                columns: table => new
                {
                    sno = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    salary_group_id = table.Column<int>(nullable: true),
                    key_id = table.Column<int>(nullable: true),
                    is_user_selected = table.Column<int>(nullable: false),
                    created_by = table.Column<int>(nullable: false),
                    created_dt = table.Column<DateTime>(nullable: false),
                    modified_by = table.Column<int>(nullable: false),
                    modified_dt = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_salary_group_key_used", x => x.sno);
                    table.ForeignKey(
                        name: "FK_tbl_salary_group_key_used_tbl_key_master_key_id",
                        column: x => x.key_id,
                        principalTable: "tbl_key_master",
                        principalColumn: "key_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_salary_group_key_used_tbl_salary_group_salary_group_id",
            ...
            migrationBuilder.CreateTable(
                name: "tbl_sg_map_key_value",
                columns: table => new
                {
                    sno = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    map_id = table.Column<int>(nullable: true),
                    key_id = table.Column<int>(nullable: true),
                    created_by = table.Column<int>(nullable: false),
                    created_dt = table.Column<DateTime>(nullable: false),
                    modified_by = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_sg_map_key_value", x => x.sno);
                    table.ForeignKey(
                        name: "FK_tbl_sg_map_key_value_tbl_key_master_key_id",
                        column: x => x.key_id,
                        principalTable: "tbl_key_master",
                        principalColumn: "key_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_sg_map_key_value_tbl_sg_maping_map_id",
                        column: x => x.map_id,
                        principalTable: "tbl_sg_maping",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_active = table.Column<int>(nullable: false),
                    is_deleted = table.Column<int>(nullable: false),
                    component_property_id = table.Column<int>(nullable: false),
                    is_payslip = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_comproperty_dtl_log", x => x.sno);
                    table.ForeignKey(
                        name: "FK_tbl_comproperty_dtl_log_tbl_company_master_company_id",
                        column: x => x.company_id,
                        principalTable: "tbl_company_master",
                        principalColumn: "company_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_comproperty_dtl_log_tbl_component_master_component_id",
                        column: x => x.component_id,
                        principalTable: "tbl_component_master",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tbl_comproperty_dtl_log_tbl_salary_group_salary_group_id",
                        column: x => x.salary_group_id,
                        principalTable: "tbl_salary_group",
                        principalColumn: "group_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_comproperty_dtl_log_company_id",
                table: "tbl_comproperty_dtl_log",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_comproperty_dtl_log_component_id",
                table: "tbl_comproperty_dtl_log",
                column: "component_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_comproperty_dtl_log_salary_group_id",
                table: "tbl_comproperty_dtl_log",
                column: "salary_group_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_create_batch_company_id",
                table: "tbl_create_batch",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_create_batch_dept_id",
                table: "tbl_create_batch",
                column: "dept_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_emp_personal_sec_bank_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_key_forumala_for_formula_id",
                table: "tbl_key_forumala",
                column: "for_formula_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_key_forumala_used_function_id",
                table: "tbl_key_forumala",
                column: "used_function_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_key_forumala_used_key_id",
                table: "tbl_key_forumala",
                column: "used_key_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_salary_group_key_used_key_id",
                table: "tbl_salary_group_key_used",
                column: "key_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_salary_group_key_used_salary_group_id",
                table: "tbl_salary_group_key_used",
                column: "salary_group_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_sg_map_key_value_key_id",
                table: "tbl_sg_map_key_value",
                column: "key_id");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_sg_map_key_value_map_id",
                table: "tbl_sg_map_key_value",
                column: "map_id");
