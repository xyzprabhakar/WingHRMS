...
namespace projContext.Migrations.Master
{
    ...
    [Migration("20220113171738_13_JAN_2022")]
    partial class _13_JAN_2022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projContext.DB.Masters.tblCodeGenrationDetails", b =>
                {
                    b.Property<int>("Sno")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("projContext.DB.Masters.tblCodeGenrationMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("projContext.DB.Masters.tblCodeGenrationDetails", b =>
                {
                    b.HasOne("projContext.DB.Masters.tblCodeGenrationMaster", "tblCodeGenrationMaster")
                        .WithMany()
                        .HasForeignKey("Id");
                });
