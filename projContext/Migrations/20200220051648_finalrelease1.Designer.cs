...
namespace projContext.Migrations
{
    ...
    [Migration("20200220051648_finalrelease1")]
    partial class finalrelease1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projContext.DB.tbl_comproperty_dtl_log", b =>
                {
                    b.Property<int>("sno")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("component_property_id");
                    ...
                    b.ToTable("tbl_comproperty_dtl_log");
                });
            ...
            modelBuilder.Entity("projContext.DB.tbl_create_batch", b =>
                {
            ...
            modelBuilder.Entity("projContext.DB.tbl_emp_manager", b =>
                {
                    ...
                    b.Property<int?>("m_three_id");

                    b.Property<int?>("m_two_id");

                    b.Property<byte>("notify_manager_1");

                    b.Property<byte>("notify_manager_2");

                    b.Property<byte>("notify_manager_3");
            ...
            modelBuilder.Entity("projContext.DB.tbl_emp_personal_sec", b =>
                {
                    ...
                    b.Property<int>("pf_applicable");

                    b.Property<double>("pf_ceilling");
            ...
            modelBuilder.Entity("projContext.DB.tbl_function_master", b =>
                {
                    b.Property<int>("function_id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("calling_function_name");

                    b.Property<int>("computation_order");
                    ...
                    b.Property<int>("function_category");
            ...
            modelBuilder.Entity("projContext.DB.tbl_key_forumala", b =>
                {
                    b.Property<int>("sno")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("static_value");

                    b.Property<string>("static_value_type");

                    b.Property<int?>("used_function_id");

                    b.Property<int?>("used_key_id");

                    b.HasKey("sno");

                    b.HasIndex("for_formula_id");

                    b.HasIndex("used_function_id");

                    b.HasIndex("used_key_id");

                    b.ToTable("tbl_key_forumala");
                });

            modelBuilder.Entity("projContext.DB.tbl_key_master", b =>
                {
                    ...
                    b.Property<string>("forumal_name")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("projContext.DB.tbl_salary_group_key_used", b =>
                {
                    b.Property<int>("sno")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("is_user_selected");
                    ...
                    b.ToTable("tbl_salary_group_key_used");
                });
            ...
            modelBuilder.Entity("projContext.DB.tbl_scheduler_details", b =>
                {
                    ...
                    b.Property<int?>("is_runing");

                    b.Property<DateTime?>("last_runing_date");

                    b.Property<int?>("number_of_week");
            ...
            modelBuilder.Entity("projContext.DB.tbl_sg_map_key_value", b =>
                {
                    b.Property<int>("sno")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("tbl_sg_map_key_value");
                });
            ...
            modelBuilder.Entity("projContext.DB.tbl_create_batch", b =>
                {
                    ...
                    b.HasOne("projContext.DB.tbl_department_master", "dept_mastr")
                        .WithMany()
            ...
            modelBuilder.Entity("projContext.DB.tbl_emp_manager", b =>
                {
                    ...
                    b.HasOne("projContext.DB.tbl_employee_master", "tbl_employee_master3")
                        .WithMany()
                        .HasForeignKey("m_three_id");

                    b.HasOne("projContext.DB.tbl_employee_master", "tbl_employee_master2")
                        .WithMany()
                        .HasForeignKey("m_two_id");
                });
            ...
            modelBuilder.Entity("projContext.DB.tbl_key_forumala", b =>
                {
                    b.HasOne("projContext.DB.tbl_key_master", "tfkm")
                        .WithMany()
                        .HasForeignKey("for_formula_id");

                    b.HasOne("projContext.DB.tbl_function_master", "tufm")
                        .WithMany()
                        .HasForeignKey("used_function_id");

                    b.HasOne("projContext.DB.tbl_key_master", "tkum")
                        .WithMany()
                        .HasForeignKey("used_key_id");
                });
            ...
            modelBuilder.Entity("projContext.DB.tbl_salary_group_key_used", b =>
                {
                    b.HasOne("projContext.DB.tbl_key_master", "tkm")
                        .WithMany()
            ...
            modelBuilder.Entity("projContext.DB.tbl_sg_map_key_value", b =>
                {
                    ...
                    b.HasOne("projContext.DB.tbl_sg_maping", "tsgme")
                        .WithMany()
